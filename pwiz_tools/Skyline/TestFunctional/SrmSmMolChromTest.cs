...
namespace pwiz.SkylineTestFunctional
{
    ...
    public class SrmSmMolChromTest : AbstractFunctionalTest
    {
        ...
        protected override void DoTest()
        {
            ...
            {
                new MsDataFileLocalUri(TestFilesDir.GetTestPath("ID36310_01_WAA263_3771_030118" + ExtensionTestContext.ExtMz5)),
                new MsDataFileLocalUri(TestFilesDir.GetTestPath("ID36311_01_WAA263_3771_030118" + ExtensionTestContext.ExtMz5))
            });
