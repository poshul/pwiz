...
namespace pwiz.Skyline.Model
{
    public class MultiProgressStatus : Immutable, IProgressStatus
    {
        ...
        public MultiProgressStatus Add(ChromatogramLoadingStatus status)
        {
            ...
            {
                if (loadingStatus.FilePath.Equals(status.FilePath)) // Compare ignoring centroiding and combineIMS flags which may update after file is opened and inspected
                {
